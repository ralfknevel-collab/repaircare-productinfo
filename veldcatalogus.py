...
VELDEN: list[Veld] = [
    ...
    # Uit de product- en veiligheidsbladen (kennisbank.json), gekoppeld via de productnaam.
    Veld("signaalwoord", "Signaalwoord (CLP)", None, "document", "Gevaar / Waarschuwing volgens het veiligheidsblad."),
    Veld("h_zinnen", "H-zinnen (gevarenaanduidingen)", None, "document", "Bijv. H315, H317, H319, H411."),
    Veld("euh_zinnen", "EUH-zinnen", None, "document", "Aanvullende gevareninformatie, bijv. EUH205."),
    Veld("gevarenklassen", "Gevarenklassen (CLP)", None, "document", "Bijv. Skin Irrit. 2, Eye Irrit. 2."),
    Veld("adr_classificatiecode", "ADR-classificatiecode", None, "document", "Bijv. M6, C7."),
    Veld("kemler", "Kemler-nummer", None, "document", "Gevaarsidentificatienummer ADR, bijv. 90."),
    Veld("dichtheid", "Dichtheid / soortelijk gewicht", None, "document", "Bijv. 1,10 kg/dm³ bij 20°C."),
    Veld("opslagtemperatuur", "Opslagtemperatuur", None, "document", "Bijv. 5 – 40 °C."),
    Veld("kleur", "Kleur", None, "document", "Kleur van het product of de componenten."),
    Veld("eural_code", "EURAL-afvalcode", None, "document", "Europese afvalcode, bijv. 08 04 09*."),
    Veld("verwerkingstemperatuur", "Verwerkingstemperatuur", None, "document", "Toegestane temperatuur bij verwerking."),
    Veld("verwerkingstijd", "Verwerkingstijd / potlife", None, "document", "Bijv. 20 – 25 minuten bij 20°C."),
    Veld("uitharding", "Uitharding / overschilderbaar na", None, "document", "Bijv. schuur- en overschilderbaar na ca. 4 uur."),
    Veld("mengverhouding", "Mengverhouding A:B", None, "document", "Bijv. A 3 : B 1 (volumedelen)."),
    Veld("laagdikte", "Laagdikte", None, "document", "Bijv. 5 – 50 mm."),
    Veld("vaste_stofgehalte", "Vaste-stofgehalte", None, "document", "Bijv. 100 vol.%."),
    Veld("certificaat", "Certificering (KOMO e.d.)", None, "document", "Bijv. KOMO BRL-0807, certificaatnummer 33333."),
    Veld("verpakking", "Verpakking (inhoud)", None, "document", "Bijv. koker A 300 ml + koker B 100 ml."),
    Veld("verpakkingseenheid", "Verpakkingseenheid (doos)", None, "document", "Bijv. kartonnen doos met 20 sets."),
    Veld("verbruik", "Verbruik", None, "document", "Bijv. 1 liter per m² per mm laagdikte."),
    Veld("biobased_gehalte", "Biobased gehalte", None, "document", "Percentage biobased grondstoffen."),
    Veld("milieugevaarlijk", "Milieugevaarlijk (ADR)", None, "document", "Ja/nee volgens veiligheidsblad of PDS."),
    Veld("sds_versie", "Versie veiligheidsblad", None, "document", "Versienummer van het veiligheidsblad."),
    Veld("sds_datum", "Datum veiligheidsblad", None, "document", "Datum herziening van het veiligheidsblad."),
